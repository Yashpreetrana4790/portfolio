    ...
    <div className='py-[70px]'>
      <div className='container mx-auto  padding-md'>
        <div className='mb-[48px]'>
          ...
          <p className=' text-[16px] sm:text-[18px] font-inter font-normal text-center max-w-[870px] mx-auto '>I am a passionate <span className='text-primary underline  decoration-yellow-500 underline-offset-6'>Full-stack Developer</span> with experience in React and Next.js, dedicated to
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 max-w-[700px] w-full mx-auto mb-[48px]'>
          <div className='sm:col-span-12'>
            <div className='flex flex-wrap justify-between'>
        ...
        <div className='flex items-center justify-center mb-[20px]' >
          <button className='flex items-center justify-center gap-3 p-3 rounded-[11px] bg-primary  text-white max-sm:w-full sm:min-w-[350px] max-h-[46px]'>
